...
gtk-update-icon-cache_BUILD_DEPENDS=	gtk-update-icon-cache:x11-toolkits/gtk30
gtk-update-icon-cache_RUN_DEPENDS=	gtk-update-icon-cache:x11-toolkits/gtk30
