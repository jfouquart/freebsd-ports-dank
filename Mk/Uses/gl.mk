...
# Feature:	gl
# Usage:	USES=gl
#		USE_GL=egl gbm gl glx glesv2 glew glu glut
#		
...
_GL_gl_LIB_DEPENDS=		libOpenGL.so:graphics/libglvnd
_GL_glx_LIB_DEPENDS=		libGL.so:graphics/libglvnd
_GL_glx_USE_XORG=		xorgproto
